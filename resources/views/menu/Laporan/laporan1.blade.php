...
<center><a href="{{ url('laporan/cetak_pdf', ['id'=> $ID ]) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin:20px;"><i class="fas fa-download fa-sm text-white-50"></i>CETAK PDF</a></center>
<!-- Begin Page Content -->
<div class="container-fluid" style=" width: 800px">
	<!-- DataTales Example -->
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">Print Perview Laporan Supplier Terpilih</h6>
		</div>
	...
	<div class="container">
		...
		<br>
		@foreach ($hasil as $h)
    <p align="center" >LAPORAN HASIL KEPUTUSAN SUPPLIER TERPILIH <br>
