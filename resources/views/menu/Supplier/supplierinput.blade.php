<div class="container-fluid">
  <ol class="breadcrumb">
    ...
    <li class="active"><span class="fa fa-cog fa-spin fa-fw"></span> Supplier </li>
  </ol>
...
<div class="card shadow mb-4">
  ...
  <div class="collapse show" id="collapseCardExample">
    <div class="card-body">
      <form method="POST" action="{{ route('InputSupplier') }}">
        @csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  <input id="tlpn" type="text" class="form-control" name="tlpn" required autofocus>
              </div>
          </div>
