...
<div class="container-fluid">
  <ol class="breadcrumb">
    ...
    <li class="active"><span class="fa fa-star fa-spin fa-fw"> </span> Edit Nilai Alternatif </li>
  </ol>
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                <select class="form-control custom-select2" name="n{{$dataa1->id_kriteria}}" required style="width: 100%; height: 38px;">
                  ...
                  @foreach ($NilaiAlternatif as $key =>$dataa3)
                  @if($dataa1->id_kriteria == $dataa3->id_kriteria)
                  <option value="{{ $dataa3->get_nilai_kriteria_alternatif->id_nilai_kriteria_alternatif }}">{{ $dataa3->get_nilai_kriteria_alternatif->nilai }} - {{  $dataa3->get_nilai_kriteria_alternatif->keterangan  }}</option>
                  @endif
                  @endforeach
